...
// void render_template(char *template, char *params[MAX_MSG_PARAM], CC_List *subst)
// {
...
//     for(size_t i = 0; i < sizeof pairs/sizeof pairs[0]; i++) cc_list_add(subst, pairs + i);
...
// // cc -Wall -g -std=c99 -Werror src/replies_test.c -Llib -llog -lcollectc