...
typedef struct _Server {
	...
	Hashtable *nick_to_user_map;	 // Map nick to user struct on  server
...
void Channel_add_member(Channel *, User *);
bool Channel_remove_member(Channel *, User *);
bool Channel_has_member(Channel *, User *);
